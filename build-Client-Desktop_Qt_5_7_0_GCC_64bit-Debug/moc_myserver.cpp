...
QT_MOC_LITERAL(1, 9, 16), // "someoneConnected"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "QTcpSocket*"
QT_MOC_LITERAL(4, 39, 6) // "msgRcv"

    },
    "MyServer\0someoneConnected\0\0QTcpSocket*\0"
    "msgRcv"
};
...
void MyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->someoneConnected((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< QTcpSocket*(*)>(_a[2]))); break;
        case 1: _t->msgRcv((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< QTcpSocket*(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyServer::*_t)(QByteArray , QTcpSocket * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyServer::someoneConnected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyServer::someoneConnected(QByteArray _t1, QTcpSocket * _t2)
{
