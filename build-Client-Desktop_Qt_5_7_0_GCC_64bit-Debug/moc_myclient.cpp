...
QT_MOC_LITERAL(3, 17, 11), // "QTcpSocket*"
QT_MOC_LITERAL(4, 29, 9) // "readyRead"

    },
    "MyClient\0msgRcv\0\0QTcpSocket*\0readyRead"
};
...
void MyClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->msgRcv((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< QTcpSocket*(*)>(_a[2]))); break;
        ...
        {
            typedef void (MyClient::*_t)(QByteArray , QTcpSocket * );
...
// SIGNAL 0
void MyClient::msgRcv(QByteArray _t1, QTcpSocket * _t2)
{
