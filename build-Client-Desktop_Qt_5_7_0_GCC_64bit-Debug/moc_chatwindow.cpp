...
QT_MOC_LITERAL(1, 11, 15), // "endConversation"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11), // "ChatWindow*"
QT_MOC_LITERAL(4, 40, 4), // "read"
QT_MOC_LITERAL(5, 45, 4), // "send"
QT_MOC_LITERAL(6, 50, 18) // "clientDisconnected"

    },
    "ChatWindow\0endConversation\0\0ChatWindow*\0"
    "read\0send\0clientDisconnected"
};
...
void ChatWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->endConversation((*reinterpret_cast< ChatWindow*(*)>(_a[1]))); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< ChatWindow* >(); break;
            }
            break;
        }
        ...
        {
            typedef void (ChatWindow::*_t)(ChatWindow * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatWindow::endConversation)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatWindow::endConversation(ChatWindow * _t1)
{
